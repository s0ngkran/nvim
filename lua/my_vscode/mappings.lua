...
vim.api.nvim_set_keymap("n", "<leader>vs", "<cmd>call VSCodeNotify('workbench.action.openGlobalKeybindings')<cr>",
  { noremap = true })


-- map leder vj to workbench.action.openSettingsJson
vim.api.nvim_set_keymap("n", "<leader>vj", "<cmd>call VSCodeNotify('workbench.action.openSettingsJson')<cr>",
  { noremap = true })

-- map leader vz to run workbench.action.toggleZenMode
vim.api.nvim_set_keymap("n", "<leader>vz", "<cmd>call VSCodeNotify('workbench.action.toggleZenMode')<cr>",
  { noremap = true })

-- map leader vm to run code ~/.config/nvim/lua
vim.keymap.set("n", "<leader>vm",
  function()
    print('edit mappings.lua')

    -- not working
    -- vim.cmd('!code /Users/walter/.config/nvim/lua/vscode/mappings.lua')
    local text = 'code /Users/walter/.config/nvim/lua/my_vscode/mappings.lua';
    vim.fn.setreg('+', text)
    -- insert_text(text)
  end
  , opts)
...
vim.keymap.set("n", "<leader>an", function()
  local writeTemp = function(text)
    vim.fn.system('echo ' .. text .. '> ~/.temp.nvim.txt')
  end
  local writeTempContinue = function(text)
    vim.fn.system('echo ' .. text .. '>> ~/.temp.nvim.txt')
  end
  local refresh = function()
    vim.cmd('!code -a ~/.temp.nvim.txt')
  end
  ...
  local res = vim.fn.system('flutter test')
  writeTemp(res)
  refresh()
...
vim.keymap.set("n", "<leader>gl", function()
  ...
  vim.fn.system(
    'git log --date=relative --graph --pretty=format:"%C(yellow)%d %C(white)%ad %C(magenta)UU%an %C(green)%h -> %C(blue)%s" --all --decorate --abbrev-commit >> ~/.temp.nvim.txt')
...
vim.api.nvim_set_keymap("n", "<leader>gc", "<cmd>call VSCodeNotify('workbench.action.terminal.newWithCwd')<cr>",
  { noremap = true })
-- unmap gcc
...
vim.api.nvim_set_keymap("n", "<leader>gk", "<cmd>call VSCodeNotify('workbench.action.terminal.killAll')<cr>",
  { noremap = true })

vim.api.nvim_set_keymap("n", "<leader>t", "<cmd>call VSCodeNotify('multiCommand.openTerminalForCurrentFile')<cr>",
  { noremap = true })
...
vim.api.nvim_set_keymap("n", "<leader>q", "<cmd>call VSCodeNotify('workbench.action.closeActiveEditor')<cr>",
  { noremap = true })
...
vim.api.nvim_set_keymap("n", "H", "<cmd>call VSCodeNotify('workbench.action.previousEditorInGroup')<cr>",
  { noremap = true })
...
vim.api.nvim_set_keymap("n", "<leader>dd", "<cmd>call VSCodeNotify('workbench.action.debug.start')<cr>",
  { noremap = true })
...
vim.api.nvim_set_keymap("n", "<leader>ds", "<cmd>call VSCodeNotify('workbench.action.debug.stop')<cr>",
  { noremap = true })
...
-- run test all
vim.api.nvim_set_keymap("n", "<leader>dT", "<cmd>call VSCodeNotify('testing.runAll')<cr>", { noremap = true })

-- run test at cursor
vim.api.nvim_set_keymap("n", "<leader>dt", "<cmd>call VSCodeNotify('testing.runAtCursor')<cr>", { noremap = true })

-- run last test
vim.api.nvim_set_keymap("n", "<leader>dl", "<cmd>call VSCodeNotify('testing.reRunLastRun')<cr>", { noremap = true })

-- toggle break point
vim.api.nvim_set_keymap("n", "<leader>dx", "<cmd>call VSCodeNotify('editor.debug.action.toggleBreakpoint')<cr>", { noremap = true })
...
vim.api.nvim_set_keymap("n", "<leader>ar", "<cmd>call VSCodeNotify('workbench.action.reloadWindow')<cr>",
  { noremap = true })
...
vim.keymap.set("n", "<leader>a,",
  function()
    combo("yy?class<CR>pciwfinal<ESC>A<ESC>r;b*yiw0wwhpld$a,<ESC>bithis.<ESC>")
  end
  , opts)
...
-- terminal
vim.api.nvim_set_keymap("n", "<leader>t", "<cmd>call VSCodeNotify('workbench.action.createTerminalEditor')<cr>",
  { noremap = true })


-- map leader wl to workbench.action.moveActiveEditorGroupRight
vim.api.nvim_set_keymap("n", "<leader>wl", "<cmd>call VSCodeNotify('workbench.action.moveActiveEditorGroupRight')<cr>",
  { noremap = true })
-- map leader wh to workbench.action.moveActiveEditorGroupLeft
vim.api.nvim_set_keymap("n", "<leader>wh", "<cmd>call VSCodeNotify('workbench.action.moveActiveEditorGroupLeft')<cr>",
  { noremap = true })
-- map leader wq to workbench.action.closeEditorsInGroup
vim.api.nvim_set_keymap("n", "<leader>wq", "<cmd>call VSCodeNotify('workbench.action.closeEditorsInGroup')<cr>",
  { noremap = true })

-- map leader ww to workbench.action.files.save
vim.api.nvim_set_keymap("n", "<leader>ww", "<cmd>call VSCodeNotify('workbench.action.files.save')<cr>",
  { noremap = true })
...
--- ui
--- ui
-- map leader gf to workbench.action.toggleMaximizedPanel === ctrl.w.=
...
--
-- map leader ud to open test explorer
vim.api.nvim_set_keymap("n", "<leader>ud", "<cmd>call VSCodeNotify('workbench.view.testing.focus')<cr>",
  { noremap = true })
...
vim.api.nvim_set_keymap("n", "<leader>uh", "<cmd>call VSCodeNotify('todohighlight.toggleHighlight')<cr>",
  { noremap = true })

-- map leader e to workbench.action.to ggleSidebarVisibility
vim.api.nvim_set_keymap("n", "<leader>e", "<cmd>call VSCodeNotify('workbench.action.toggleSidebarVisibility')<cr>",
  { noremap = true })

-- map leader o to workbench.files.action.focusFilesExplorer
vim.api.nvim_set_keymap("n", "<leader>o", "<cmd>call VSCodeNotify('workbench.files.action.focusFilesExplorer')<cr>",
  { noremap = true })

-- show hover
vim.api.nvim_set_keymap("n", "<leader>k", "<cmd>call VSCodeNotify('editor.action.showDefinitionPreviewHover')<cr>",
  { noremap = true })
...
vim.api.nvim_set_keymap("n", "<leader>b", "<cmd>call VSCodeNotify('workbench.action.showEditorsInActiveGroup')<cr>",
  { noremap = true })

-- map leader j to workbench.action.switchWindow
vim.api.nvim_set_keymap("n", "<leader>j", "<cmd>call VSCodeNotify('workbench.action.switchWindow')<cr>",
  { noremap = true })

-- map leader h to search method
vim.api.nvim_set_keymap("n", "<leader>h", "<cmd>call VSCodeNotify('workbench.action.gotoSymbol')<cr>", { noremap = true })

-- map leader W to workbench.action.findInFiles
vim.api.nvim_set_keymap("n", "<leader>W", "<cmd>call VSCodeNotify('workbench.action.findInFiles')<cr>",
  { noremap = true })

-- map leader wm to open current file on the new window
...
vim.api.nvim_set_keymap("n", "<leader>al", "<cmd>call VSCodeNotify('turboConsoleLog.displayLogMessage')<cr>",
  { noremap = true })
